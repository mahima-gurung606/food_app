                  ...
                  return Dismissible(
                    ...
                    onDismissed: (direction) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                              "${ms.favproduct[index].name} removed from favorites"),
                        ),
                      );
                    },
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          '\$',
                                          style: mystyle(19, primaryColor,
                                              FontWeight.bold),
                                        ),
                                        Text(
                                          '${ms.favproduct[index].price}',
                                          style: mystyle(19, Colors.black,
                                              FontWeight.bold),
                                        )
                                      ],
                                    ),
